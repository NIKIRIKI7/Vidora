...
import { Logs, Plus, GripVertical, Minus, Mic, Download, Upload, Trash2, SlidersHorizontal, MicVocal, Play, AlignStartVertical, RotateCcw, Cpu, AudioLines, Code, Copy, Film, FileOutput, FileAudio, Sparkles, Video, Volume2, ChevronDown, ChevronUp } from 'lucide-react'
import { DEFAULT_BACKGROUND_MUSIC, ARCHETYPE_MARKER, detectArchetype, stripArchetypeMarker, type VisualArchetype } from '@shared/config'
