"""Фундаментальный резолвер путей и валидатор файловой песочницы (Core Security).

Каноническая реализация живёт в ядре — слой core не зависит от infrastructure.
Infrastructure/media лишь реэкспортируют эти примитивы для обратной совместимости.
"""
...
ALLOWED_ASSET_FOLDERS: Set[str] = {"b-roll", "voice", "music", "refs", "a-roll", "data", "preview", "code"}


class PathResolver:
    """Безопасное разрешение путей файловой системы и защита от Path Traversal."""
