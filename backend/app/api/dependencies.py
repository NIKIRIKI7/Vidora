...
def get_code_gen_service(
    ...
    return CodeGenService(llm_gateway=llm_gateway, history_repo=history_repo)
...
def get_system_service(
    ...
    return SystemService(history_repo=history_repo)


def get_youtube_service(
        llm_gateway: LLMGateway = Depends(get_llm_gateway),
) -> YouTubeService:
    return YouTubeService(llm_gateway=llm_gateway)
